...
def send_otp(request):
    ...
    # **Development Mode: Print OTP instead of sending via Twilio**
    print(f"OTP for {phone_number}: {otp}")

    return Response({"message": "OTP sent successfully (Check Console)", "otp": otp})  # Keep "otp" for testing, remove in production
